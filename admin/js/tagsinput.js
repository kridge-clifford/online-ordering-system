...
(function ($) {
  ...
  function TagsInput(element, options) {
    ...
    this.$input = $('<input class="variant_option" type="text" placeholder="' + this.placeholderText + '"/> <div class="invalid-feedback">Please enter a options</div>').appendTo(this.$container);
